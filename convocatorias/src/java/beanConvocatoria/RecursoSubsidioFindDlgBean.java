...
public class RecursoSubsidioFindDlgBean {
    ...
    private RecursoSubsidio recursoSubsidio;
    ...
    public RecursoSubsidioFindDlgBean() {
        recursoSubsidio = new RecursoSubsidio();
    }
    ...
    public RecursoSubsidio getRecursoSubsidio() {
        return recursoSubsidio;
    }

    public void setRecursoSubsidio(RecursoSubsidio recursoSubsidio) {
        this.recursoSubsidio = recursoSubsidio;
    }
            ...
            switch (this.getTipo()) {
                case 0:
                    ...
                    if (this.getProyectoWebBean().getProyectoWeb().getRecursosSubsidios() == null) {
                        this.getProyectoWebBean().getProyectoWeb().setRecursosSubsidios(new ArrayList<RecursoSubsidio>());
                    }//fin if
