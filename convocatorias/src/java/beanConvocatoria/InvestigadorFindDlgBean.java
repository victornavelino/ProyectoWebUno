    ...
    public void definirComponentesActualizar() {
        ...
        try {
            ...
            if (this.getProyectoWebBean().getProyectoWeb().getParticipacionesWeb() == null) {
                this.getProyectoWebBean().getProyectoWeb().setParticipacionesWeb(new ArrayList<ParticipacionWeb>());
            }//fin if
...
//                    break;
                ...
                case 2:
                    ...
                    this.getParticipacionWebFindDlgBean().setParticipacionWeb(new ParticipacionWeb());
