    ...
    public void actualizarPresupuestoAniosBienConsumo(int anio) {
        ...
        switch (anio) {
            case 1:
                ...
                for (BienConsumoWeb bcw : this.getProyectoWebBean().getProyectoWeb().
    ...
    public void actualizarPresupuestoAniosBienNoPersonal(int anio) {
        ...
        switch (anio) {
            case 1:
                ...
                for (BienNoPersonalWeb bnpw : this.getProyectoWebBean().getProyectoWeb().
    ...
    public void actualizarPresupuestoAniosBienUso(int anio) {
        ...
        switch (anio) {
            case 1:
                ...
                for (BienUsoWeb buw : this.getProyectoWebBean().getProyectoWeb().
    ...
    public void actualizarPresupuestoAniosGastosViaje(int anio) {
        ...
        switch (anio) {
            case 1:
                ...
                for (GastoViajeWeb gvw : this.getProyectoWebBean().getProyectoWeb().
    ...
    public void definirComponentesActualizar() {
        try {
            ...
            if (this.getProyectoWebBean().getProyectoWeb().
                ...
                this.getProyectoWebBean().getProyectoWeb().
                        setPresupuestoWeb(new PresupuestoWeb());
            }//fin if
