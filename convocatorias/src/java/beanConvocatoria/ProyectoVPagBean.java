...
public class ProyectoVPagBean {
    ...
    public BigDecimal calcularTotal(PresupuestoWeb presupuestoWeb){
    ...
    public BigDecimal calcularTotalColumna(PresupuestoWeb presupuestoWeb){
            ...
            case 1:
                if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno() != null) {
                    if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienConsumoWeb() != null) {
                        for (BienConsumoWeb bcw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienConsumoWeb()) {
           ...
           case 2:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos()!= null) {
                    if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienConsumoWeb() != null) {
                        for (BienConsumoWeb bcw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienConsumoWeb()) {
                            suma = suma.add(bcw.getValor());
                        }//fin for
                    }//fin if
                }
          ...
          case 3:
              ...
              if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres()!= null) {
                    if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienConsumoWeb() != null) {
                        for (BienConsumoWeb bcw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienConsumoWeb()) {
                            suma = suma.add(bcw.getValor());
                        }//fin for
                    }//fin if
                }
           ...
           case 4:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro()!= null) {
                    if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienConsumoWeb() != null) {
                        for (BienConsumoWeb bcw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienConsumoWeb()) {
                            suma = suma.add(bcw.getValor());
                        }//fin for
                    }//fin if
                }
           ...
           case 1:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno() != null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienNoPersonalWeb() != null) {
                       for (BienNoPersonalWeb bnpw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienNoPersonalWeb()) {
           ...
           case 2:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienNoPersonalWeb() != null) {
                       for (BienNoPersonalWeb bnpw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienNoPersonalWeb()) {
                           suma = suma.add(bnpw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 3:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienNoPersonalWeb() != null) {
                       for (BienNoPersonalWeb bnpw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienNoPersonalWeb()) {
                           suma = suma.add(bnpw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 4:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienNoPersonalWeb() != null) {
                       for (BienNoPersonalWeb bnpw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienNoPersonalWeb()) {
                           suma = suma.add(bnpw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 1:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno() != null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienUsoWeb() != null) {
                       for (BienUsoWeb buw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getBienUsoWeb()) {
           ...
           case 2:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienUsoWeb() != null) {
                       for (BienUsoWeb buw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getBienUsoWeb()) {
                           suma = suma.add(buw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 3:
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienUsoWeb() != null) {
                       for (BienUsoWeb buw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getBienUsoWeb()) {
                           suma = suma.add(buw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 4:
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienUsoWeb() != null) {
                       for (BienUsoWeb buw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getBienUsoWeb()) {
                           suma = suma.add(buw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
           ...
           case 1:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno() != null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getGastosViajeWeb() != null) {
                       for (GastoViajeWeb gvw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioUno().getGastosViajeWeb()) {
           ...
           case 2:
               ...
               if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getGastosViajeWeb() != null) {
                       for (GastoViajeWeb gvw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioDos().getGastosViajeWeb()) {
                           suma = suma.add(gvw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
          ...
          case 3:
              ...
              if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getGastosViajeWeb() != null) {
                       for (GastoViajeWeb gvw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioTres().getGastosViajeWeb()) {
                           suma = suma.add(gvw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
          ...
          case 4:
              if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro()!= null) {
                   if (this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getGastosViajeWeb() != null) {
                       for (GastoViajeWeb gvw : this.getProyectoWebBean().getProyectoWeb().getPresupuestoWebAnioCuatro().getGastosViajeWeb()) {
                           suma = suma.add(gvw.getValor());
                       }//fin for
                   }//fin if
               }//fin if
   ...
   public void quitarBienConsumoAnios(BienConsumoWeb bc, int anio){
    ...
    public void quitarBienNoPersonalAnios(BienNoPersonalWeb bnp, int anio){
    ...
    public void quitarBienUsoAnios(BienUsoWeb bu, int anio){
    ...
    public void quitarGastoViajeAnios(GastoViajeWeb gv, int anio){
    ...
    public void quitarRecursoSubsidio(RecursoSubsidio rs){
