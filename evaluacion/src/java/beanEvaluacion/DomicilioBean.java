...
public class DomicilioBean {
    ...
    public void cargarDomicilio() {
        ...
        System.out.println(" domicilio: " +this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getDomicilio());
        if(this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getDomicilio().getLocalidad()!=null){
        this.setProvincia(this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getDomicilio().getLocalidad().getDepartamento().getProvincia());
        this.cargarDepartamentos();
        this.setDepartamento(this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getDomicilio().getLocalidad().getDepartamento());
        this.cargarLocalidades();
        this.setLocalidad(this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getDomicilio().getLocalidad());
        }
        
        //telefono
        
        this.getListadoTelefonosBean().setLstTelefonos(this.getEvaluadorLoginBean().getEvaluador().getInvestigador().getPersona().getTelefonos());
    }
}
