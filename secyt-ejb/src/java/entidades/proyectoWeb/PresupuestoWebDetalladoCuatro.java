 ...
 */
@Entity
@Table(name = "proyectoweb_presupuesto_detalladoc")
public class PresupuestoWebDetalladoCuatro implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PresupuestoWebDetalladoCuatro)) {
            return false;
        }
        PresupuestoWebDetalladoCuatro other = (PresupuestoWebDetalladoCuatro) object;
    ...
    public String toString() {
        return "entidades.proyectoWeb.PresupuestoWebDetalladoCuatro[ id=" + id + " ]";
    }
