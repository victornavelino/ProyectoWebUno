 ...
 */
@Entity
@Table(name = "proyectoweb_presupuesto_detalladot")
public class PresupuestoWebDetalladoTres implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PresupuestoWebDetalladoTres)) {
            return false;
        }
        PresupuestoWebDetalladoTres other = (PresupuestoWebDetalladoTres) object;
    ...
    public String toString() {
        return "entidades.proyectoWeb.PresupuestoWebDetalladoTres[ id=" + id + " ]";
    }
