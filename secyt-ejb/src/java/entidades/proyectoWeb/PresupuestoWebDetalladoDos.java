 ...
 */
@Entity
@Table(name = "proyectoweb_presupuesto_detalladod")
public class PresupuestoWebDetalladoDos implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PresupuestoWebDetalladoDos)) {
            return false;
        }
        PresupuestoWebDetalladoDos other = (PresupuestoWebDetalladoDos) object;
    ...
    public String toString() {
        return "entidades.proyectoWeb.PresupuestoWebDetalladoDos[ id=" + id + " ]";
    }
