...
public class RecursosHumanos implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RecursosHumanos)) {
            return false;
        }
        RecursosHumanos other = (RecursosHumanos) object;
    ...
    public String toString() {
        return "entidades.proyecto.vinculacion.financiacion.pfip.RecursosHumanos[ id=" + id + " ]";
    }
