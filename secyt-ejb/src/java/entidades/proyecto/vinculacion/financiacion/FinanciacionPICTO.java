 ...
 */
@Entity
@Table(name="vinculacion_financiacion_picto")
@DiscriminatorValue("PICTO")
public class FinanciacionPICTO extends Financiacion implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FinanciacionPICTO)) {
            return false;
        }
        FinanciacionPICTO other = (FinanciacionPICTO) object;
