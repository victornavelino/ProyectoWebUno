 ...
 */
@Entity
@Table(name="materialeseinsumos")
public class MaterialesEInsumos implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MaterialesEInsumos)) {
            return false;
        }
        MaterialesEInsumos other = (MaterialesEInsumos) object;
    ...
    public String toString() {
        return "entidades.proyecto.vinculacion.financiacion.picto.MaterialesEInsumos[ id=" + id + " ]";
    }
