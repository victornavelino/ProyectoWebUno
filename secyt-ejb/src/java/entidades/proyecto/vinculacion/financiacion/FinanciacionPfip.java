 ...
 */
@Entity
@Table(name="vinculacion_financiacion_pfip")
@DiscriminatorValue("PFIP")
public class FinanciacionPfip extends Financiacion implements Serializable {
 ...
 public List<RecursoHumanoAdquirir> getRecursosHumanosAdquirir() {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FinanciacionPfip)) {
            return false;
        }
        FinanciacionPfip other = (FinanciacionPfip) object;
