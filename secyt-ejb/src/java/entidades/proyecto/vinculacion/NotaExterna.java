 ...
 */
@Entity
@Table(name="notaexterna")
public class NotaExterna implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof NotaExterna)) {
            return false;
        }
        NotaExterna other = (NotaExterna) object;
    ...
    public String toString() {
        return "entidades.proyecto.vinculacion.NotaExterna[ id=" + id + " ]";
    }
